...
return [
    ...
    "media"=>[
        "groups"=>[
            ...
            "default"=>[
                "ext"=>["jpg", "jpeg", "png", "gif", "bmp", "docx", "JPG", "webp"],  // Added "webp"
                "mime"=>["image/png", "image/jpeg", "image/gif", "image/bmp", "image/webp", 'application/vnd.openxmlformats-officedocument.wordprocessingml.document'],  // Added "image/webp"
                "max_size"=>20000000, // In Bytes, default is 20MB
                "max_width"=>env('ALLOW_IMAGE_MAX_WIDTH', 4000),
                "max_height"=>env('ALLOW_IMAGE_MAX_HEIGHT', 4000)
            ],
            "image"=>[
                "ext"=>["jpg", "jpeg", "png", "gif", "bmp", "JPG", "webp"],  // Added "webp"
                "mime"=>["image/png", "image/jpeg", "image/gif", "image/bmp", "image/webp"],  // Added "image/webp"
                "max_size"=>20000000, // In Bytes, default is 20MB
                "max_width"=>env('ALLOW_IMAGE_MAX_WIDTH', 4000),
                "max_height"=>env('ALLOW_IMAGE_MAX_HEIGHT', 4000)
            ],
