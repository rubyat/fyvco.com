...
@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar">{{!empty($recovery) ? __('Recovery') : __("All Villas")}}</h1>
            <div class="title-actions">
                @if(empty($recovery))
                <a href="{{route('hotel.admin.create')}}" class="btn btn-primary">{{__("Add new villa")}}</a>
                @endif
            </div>
        </div>
                                        ...
                                        @if(empty($recovery))
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a class="dropdown-item" href="{{route('hotel.admin.edit',['id'=>$row->id])}}">{{__("Edit Villa")}}</a>
