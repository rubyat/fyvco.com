        ...
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 d-none" data-condition="hotel_location_search_style:is(autocompletePlace)">
...
<div class="row">
    <div class="col-sm-4">
        <h3 class="form-group-title">{{__("Disable villa booking?")}}</h3>
    </div>
    <div class="col-sm-8">
        <div class="panel">
            <div class="panel-title"><strong>{{__("Disable villa booking")}}</strong></div>
            <div class="panel-body">
                <div class="form-group">
                    <div class="form-controls">
                    <label><input type="checkbox" name="hotel_booking_disable" value="1" @if(setting_item('hotel_booking_disable')) checked @endif > {{__('Yes, please disable it')}}</label>
                    </div>
                </div>
            </div>
        </div>
