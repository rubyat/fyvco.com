                                ...
                                <div class="form-group form-date-field form-date-search clearfix position-relative" data-format="{{get_moment_date_format()}}">
                                    <div class="date-wrapper clearfix" @click="openStartDate">
                                        <div class="check-in-wrapper">
                                            ...
                                            <div class="render check-in-render car_input_date_range" :class="{'has-date': start_date}" v-html="start_date_html"></div>
                                            @if(!empty($row->min_day_before_booking))
                                                <div class="render check-in-render car_input_date_range">
                                                    <small>
