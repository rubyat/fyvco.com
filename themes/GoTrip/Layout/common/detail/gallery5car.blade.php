<div class="cruiseSlider">
    ...
    <div class="cruiseSlider-slides row- y-gap-10 pt-10 js-cruise-slides justify-content-center js-section-slider fyv_car_gallery" data-gap="5" data-slider-cols="xl-5 lg-3 md-2 sm-2 base-1" data-nav-prev="js-places-prev" data-pagination="js-places-pag" data-nav-next="js-places-next">
        <div class="swiper-wrapper">
            @foreach($row->getGallery() as $key => $item)
                <div class="col-auto w-max-120 swiper-slide">
