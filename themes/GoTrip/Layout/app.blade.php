...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/custom.css') }}?_v=1.54">
...
<body class="frontend-page {{ !empty($row->header_style) ? "header-".$row->header_style : "header-normal" }} {{$body_class ?? ''}} @if(setting_item_with_lang('enable_rtl')) is-rtl @endif @if(is_api()) is-api @endif @if(Request::is('/')) home-page @endif">
    ...
    <div class="bravo_wrap overflow-hidden">
        ...
        @yield('content')
        @include('Layout::parts.searchToggole')
