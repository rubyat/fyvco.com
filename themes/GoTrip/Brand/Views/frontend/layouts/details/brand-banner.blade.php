...
<div class="row x-gap-20 y-gap-20 items-center pt-20">
    ...
    @if(!empty($types))
        @foreach($types as $type=>$moduleClass)
            ...
            @endphp
            <div class="col">
                <a href="{{ $moduleClass::getLinkForPageSearch(false,['brand_id'=>$row->id]) }}" class="d-flex flex-column justify-center px-20 py-15 rounded-4 border-light text-16 lh-14 fw-500 col-12">
