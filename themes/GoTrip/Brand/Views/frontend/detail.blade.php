@extends('layouts.app')
@push('css')
    <link href="{{ asset('dist/frontend/module/brand/css/brand.css?_ver='.config('app.asset_version')) }}" rel="stylesheet">
    ...
    <div class="bravo_detail_brand">
        ...
        <section class="layout-pb-md">
            <div class="container">
                ...
                @include('Brand::frontend.layouts.details.brand-banner')

                @include('Brand::frontend.layouts.details.brand-overview')
