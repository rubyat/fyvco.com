...
<?php switch($headerStyle):
    ...
    <?php default: ?>
        <header data-add-bg="<?php echo e($dataBg); ?>" class="header <?php echo e($headerClass); ?> js-header bravo_header style-<?php echo e($headerStyle); ?>" data-x="header" data-x-toggle="is-menu-opened">
            ...
            <?php if($headerStyle == 'transparent_v3' || $headerStyle == 'transparent_v2'): ?>
    ...
    <?php break; ?>
<?php endswitch; ?>
<?php /**PATH /Applications/MAMP/htdocs/fyvco.com/themes/GoTrip/Layout/parts/header.blade.php ENDPATH**/ ?>